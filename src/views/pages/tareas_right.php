<h2 class="titulo-gestor">Gestor de tareas</h2>

<?php include __DIR__ . "/../../components/tareas_button_add.php"; ?>
<?php include __DIR__ . "/../../components/tareas_modal_create.php"; ?>
...
<script src="/public/js/tareas_modal_delete.js"></script>
